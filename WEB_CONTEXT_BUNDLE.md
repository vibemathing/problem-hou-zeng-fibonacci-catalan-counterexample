...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "hou-zeng-fibonacci-catalan-counterexample",
      "Prime plus Fibonacci plus Catalan sums conjecture: explicit counterexample"
    ],
    "allowed_axioms": [
      "none"
    ],
    ...
    "problem_id": "problem:hou-zeng-fibonacci-catalan-counterexample",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "hou-zeng-fibonacci-catalan-counterexample",
        "url": "http://maths.nju.edu.cn/~zwsun/MSPT.htm"
      },
      {
        "retrieved_at": "2026-09-08T08:24:29Z",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Prime plus Fibonacci plus Catalan sums conjecture: explicit counterexample. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Prime plus Fibonacci plus Catalan sums conjecture: explicit counterexample",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "ec1fcd9d6d0489fa246210fde4ab72a20597b80d81d77be9805a222995e8a5bc"
}
```
